# Polybot Setup — A Beginner's Manual
...
```bash
git clone <the-repo-url> polybot
cd polybot
python -m venv .venv
...
> Tip: you can ask Claude Code to run these for you, but it's good to see them
> work once yourself.
...
double-check this in Section 8.
...
**To see exactly what it did with real money:**
